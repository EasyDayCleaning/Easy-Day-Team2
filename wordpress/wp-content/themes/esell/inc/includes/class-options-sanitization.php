...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'esell' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'esell' ),
		'repeat-y'  => __( 'Repeat Vertically', 'esell' ),
		'repeat'    => __( 'Repeat All', 'esell' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'esell' ),
		'top center'    => __( 'Top Center', 'esell' ),
		'top right'     => __( 'Top Right', 'esell' ),
		'center left'   => __( 'Middle Left', 'esell' ),
		'center center' => __( 'Middle Center', 'esell' ),
		'center right'  => __( 'Middle Right', 'esell' ),
		'bottom left'   => __( 'Bottom Left', 'esell' ),
		'bottom center' => __( 'Bottom Center', 'esell' ),
		'bottom right'  => __( 'Bottom Right', 'esell')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'esell' ),
		'fixed'  => __( 'Fixed in Place', 'esell')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'esell' ),
		'italic'      => __( 'Italic', 'esell' ),
		'bold'        => __( 'Bold', 'esell' ),
		'bold italic' => __( 'Bold Italic', 'esell' )
		);
