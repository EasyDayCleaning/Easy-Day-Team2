...
function esell_breadcrumbs() {
    ...
    if (is_category()) {
        ...
        echo $before . __('Archive by category "' . single_cat_title('', false) . '"', 'esell') . $after;
    } elseif (is_day()) {
        ...
        echo $before . __('Search results for "' . get_search_query() . '"','esell') . $after;
    } elseif (is_tag()) {
        echo $before . __('Posts tagged "' . single_tag_title('', false) . '"','esell') . $after;
    } elseif (is_author()) {
        global $author;
