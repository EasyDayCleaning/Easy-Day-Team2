	...
	$sections[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'subtitle' => __('Switch on to enable boxed layout.', 'redux-framework'),
	...
	-----------------------------------------------------------------------------------*/
		...
		'fields' => array(
			...
			array(
				...
				'subtitle' => __('Specify the pre header style.', 'redux-framework'),
			...
			array(
				...
				'type'=>'info',
				'style'=>'help',
				'desc' => __( '<span class="redux-title">Header Content</span>', 'redux-framework')
				),

			array(
				'title' => __('Enable Search (Pre Header)', 'redux-framework'), 
				'subtitle' => __('Switch on to enable pre header search.', 'redux-framework'),
	...
	-----------------------------------------------------------------------------------*/	
		...
		'fields' => array(
			...
			array(
				...
				'type'=>'promotion',
				'image' => get_template_directory_uri()  . '/admin/main/assets/img/promotion/1_trusted_team.png',
				'feat' => '//www.thinkupthemes.com/themes/sento/',
				),
